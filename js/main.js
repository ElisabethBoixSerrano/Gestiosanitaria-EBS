...
function ocultaGestioPacients(objecteRebut){
   ...
   function crearHospital() {
	...
	var htmlINICIInputCognomPacient = `<input type=\"text\" title=\"Entra el nifdel pacient!\" name=\"Cognom Pacient\" 
                                  onblur=\"validaQueNoEsBuit(this)\" placeHolder=\"Cognom pacient\" id=\"cognomPacient`;
								  
	 var htmlINICIInputNifPacient = `<input type=\"text\" title=\"Entra el nifdel pacient!\" name=\"Nom Pacient\" 
                                  onblur=\"validaQueNoEsBuit(this)\" placeHolder=\"NIF pacient\" id=\"nifPacient`;
								  
	//var htmlINICIInputSelect = '<div id="contenidor';
	...
	var htmlFINALClassFormCtrl = '" class="form-control" required minlength="1" maxlength="100">';
	  ...
	  for (var pacient = 0; pacient < maximPacients; pacient++) {
		...
		var htmlLabelCognomPacient = `<label for=\"nomPacient${pacient}\" class=\"font-weight-bold\">Cognom pacient:</label>`;
		var htmlLabelNifPacient = `<label for=\"nifPacient${pacient}\" class=\"font-weight-bold\">NIF pacient:</label>`;
